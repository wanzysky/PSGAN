...
def parse_args():
    ...
    # general
    parser.add_argument('--data_path', default='', type=str, help='training and test data path')
    ...
    parser.add_argument('--num_workers', default='16', type=int, help='nums of workers')
    ...
    parser.add_argument('--lambda_skin', default='0.1', type=float, help='histogram loss on skin equals to lambda_his* lambda_skin')
